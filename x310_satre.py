...
class x310_satre(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "x310_satre")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_short*1, '/tmp/220409_08h06_satre_short_5MSps_B210_20dB_50dB.bin', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_complex_to_interleaved_short_0 = blocks.complex_to_interleaved_short(False,32767)
        ...
        self.connect((self.blocks_interleave_0, 0), (self.blocks_complex_to_interleaved_short_0, 0))
